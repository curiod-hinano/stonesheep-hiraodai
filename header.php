            ...
            <div class="header_wrap">
                <div class="header_wrap_bl01">
                    ...
                    <div class="header_news">
                        <a class="header_news_link" href="<?php echo home_url(); ?>">
                            ...
                            <span class="header_news_link_body" style="background-color: <?php echo $newsBkColor; ?>;">
                                ...
                                <span class="header_news_link_body_ttl" style="color: <?php echo $newsTxtColor; ?>;">タイトルタイトル</span>
                                <span class="header_news_link_body_date" style="color: <?php echo $newsTxtColor; ?>;">2025.10.01</span>
                                <span class="header_news_link_body_time" style="color: <?php echo $newsTxtColor; ?>;">10:00~12:00</span>
                                <span class="header_news_link_body_txt">丘の上のサンゴに問いかける、石の沈黙に、耳をすます。<br>思考が空っぽになる。風景が満ちてくる…<br>3億年の時が生んだ奇跡と、自己の内面とが交差する、特別な場所。</span>
                            </span>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="header_menuList_wrap">
                        ...
                        <ul class="header_menuList_wrap_01">
                            ...
                            <li class="page feature header_menuList_link">
                                ...
                                <ul class="sub_menu">
                                    <li><a href="<?php echo home_url(); ?>#special1" style="<?php echo $colorLogo; ?>">自分だけのたからものを探す旅</a></li>
                                </ul>
                            </li>
