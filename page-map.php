...
<div class="page_body">
    <div class="page_body_content map">
        ...
        <div class="page_body_content_txt">
            <div class="page_body_content_txt_wrap">
                <h2>HIRAODAI ACCESS</h2>
                <div class="page_body_content_txt_bl" style="padding-top:0;">
                    <p>
                        お車の場合<br>
                        ■九州自動車道をご利用の場合<br>
                        　小倉南IC（田川・香春方面）下車<br>
                        　国道322号　＜3km＞<br>
                        　「平尾台入口」信号を左折<br>
                        　県道28号線（平尾台登山道）　＜6km＞<br>
                        　点滅信号右手側に「平尾台自然観察センター」<br>
                        　所要時間約9キロ、20分<br><br><br>
                        ■北九州都市高速をご利用の場合<br>
                        　北方ランプ下車<br>
                        　国道322号を田川・香春方面へ<br>
                        　「平尾台入口」信号を左折<br>
                        　県道28号線（平尾台登山道）　＜6km＞<br>
                        　点滅信号右手側に「平尾台自然観察センター」<br>
                        　所要時間約15キロ、25分<br><br><br>
                        ■東九州自動車道<br>
                        　行橋IC下車<br>
                        　県道28号長尾右折<br>
                        　平尾台入口左折<br>
                        　点滅信号左手側に「平尾台自然観察センター」<br>
                        　所要時間約10キロ、16分 
                    </p>
                </div>
                <div class="page_body_content_txt_bl">
                    <p>
                        お車の場合<br>
                        ■九州自動車道をご利用の場合<br>
                        　小倉南IC（田川・香春方面）下車<br>
